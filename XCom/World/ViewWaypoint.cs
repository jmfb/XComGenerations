...
public class ViewWaypoint : Screen
{
	public ViewWaypoint(Waypoint waypoint)
	{
		...
		AddControl(
			new Label(54, Label.CenterOf(32, 192), waypoint.Name, Font.Large, ColorScheme.Yellow)
		);
		AddControl(
			new Label(74, Label.CenterOf(32, 192), "TARGETED BY:", Font.Normal, ColorScheme.Green)
		);
		AddControl(
			new Label(
				84,
				Label.CenterOf(32, 192),
				waypoint.TargetedBy.Name,
				Font.Normal,
				ColorScheme.Green
			)
		);
