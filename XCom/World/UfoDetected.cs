...
namespace XCom.World
{
	public class UfoDetected : Screen
	{
		...
		private void DisplayHyperWaveTransmissions()
		{
			//TODO
			AddControl(
				new Button(144, 48, 160, 12, "CANCEL", ColorScheme.Aqua, Font.Normal, EndModal)
			);
		}
		...
		private void DisplayBasicRadarResults()
		{
			...
			AddControl(
				new Label(82, 130, ufo.UfoType.Metadata().Size, Font.Normal, ColorScheme.Yellow)
			);
