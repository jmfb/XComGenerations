		...
		public RedirectCraft(Craft craft)
		{
			...
			AddControl(
				new LabeledValue(
					...
					32,
					"MAXIMUM SPEED>",
					craft.CraftType.Metadata().Speed.FormatNumber(),
					Font.Normal,
					ColorScheme.Green,
					ColorScheme.Aqua
				)
			...
			if (craft.Weapons.Count >= 1)
				AddControl(
					new LabeledValue(
						...
						164,
						"ROUNDS>",
						craft.Weapons[0].Ammunition.FormatNumber(),
						Font.Normal,
						ColorScheme.Green,
						ColorScheme.Aqua
					)
			...
			if (craft.Weapons.Count == 2)
				AddControl(
					new LabeledValue(
						...
						164,
						"ROUNDS>",
						craft.Weapons[1].Ammunition.FormatNumber(),
						Font.Normal,
						ColorScheme.Green,
						ColorScheme.Aqua
					)
			...
			AddControl(
				new Button(148, 32, 192, 12, "PATROL", ColorScheme.Aqua, Font.Normal, OnPatrol)
			);
			AddControl(
				new Button(164, 32, 192, 12, "CANCEL", ColorScheme.Aqua, Font.Normal, EndModal)
			);
		}
