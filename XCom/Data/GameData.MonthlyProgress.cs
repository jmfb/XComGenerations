...
public partial class GameData
{
	private void PerformMonthlyUpdates()
	{
		...
		Countries.Single(country => country.CountryType == CountryType.UnitedStates).Satisfaction =
			CountrySatisfaction.Happy;
		Countries.Single(country => country.CountryType == CountryType.UnitedKingdom).Satisfaction =
			CountrySatisfaction.Happy;
