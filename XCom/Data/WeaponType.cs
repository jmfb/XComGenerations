...
public static class WeaponTypeExtensions
{
	...
	private static readonly WeaponMetadata pistol = new WeaponMetadata
	{
		...
		Shots = new[] { Shot.Snap(60, 18), Shot.Aimed(78, 30) },
		Weight = 5,
		Image = Items.Pistol,
		Width = 1,
		Height = 2,
	...
	private static readonly WeaponMetadata rifle = new WeaponMetadata
	{
		...
		Shots = new[] { Shot.Auto(35, 35), Shot.Snap(60, 25), Shot.Aimed(110, 80) },
		Weight = 8,
		IsTwoHanded = true,
		Image = Items.Rifle,
		Width = 1,
	...
	private static readonly WeaponMetadata heavyCannon = new WeaponMetadata
	{
		...
		Shots = new[] { Shot.Snap(60, 33), Shot.Aimed(90, 80) },
		Weight = 18,
		IsTwoHanded = true,
	...
	private static readonly WeaponMetadata autoCannon = new WeaponMetadata
	{
		...
		Shots = new[] { Shot.Auto(32, 40), Shot.Snap(56, 33), Shot.Aimed(82, 80) },
		Weight = 19,
		IsTwoHanded = true,
	...
	private static readonly WeaponMetadata rocketLauncher = new WeaponMetadata
	{
		...
		Shots = new[] { Shot.Snap(55, 45), Shot.Aimed(115, 75) },
		Weight = 10,
		IsTwoHanded = true,
	...
	private static readonly WeaponMetadata laserPistol = new WeaponMetadata
	{
		...
		Shots = new[] { Shot.Auto(28, 25), Shot.Snap(40, 20), Shot.Aimed(68, 55) },
		Weight = 7,
	...
	private static readonly WeaponMetadata laserRifle = new WeaponMetadata
	{
		...
		Shots = new[] { Shot.Auto(46, 34), Shot.Snap(65, 25), Shot.Aimed(100, 50) },
		Weight = 8,
		IsTwoHanded = true,
	...
	private static readonly WeaponMetadata heavyLaser = new WeaponMetadata
	{
		...
		Shots = new[] { Shot.Snap(50, 33), Shot.Aimed(84, 75) },
		Weight = 18,
		IsTwoHanded = true,
		Image = Items.HeavyLaser,
		Width = 2,
		Height = 3,
		DescriptionLines = new[] { "The heavy laser is cumbersome, but extremely effective." },
	...
	private static readonly WeaponMetadata heavyPlasma = new WeaponMetadata
	{
		...
		Shots = new[] { Shot.Auto(50, 35), Shot.Snap(75, 30), Shot.Aimed(110, 60) },
		Weight = 8,
		IsTwoHanded = true,
	...
	private static readonly WeaponMetadata plasmaRifle = new WeaponMetadata
	{
		...
		Shots = new[] { Shot.Auto(55, 36), Shot.Snap(86, 30), Shot.Aimed(100, 60) },
		Weight = 5,
		IsTwoHanded = true,
	...
	private static readonly WeaponMetadata plasmaPistol = new WeaponMetadata
	{
		...
		Shots = new[] { Shot.Auto(50, 30), Shot.Snap(65, 30), Shot.Aimed(85, 60) },
		Weight = 3,
	...
	private static readonly WeaponMetadata smallLauncher = new WeaponMetadata
	{
		...
		Shots = new[] { Shot.Snap(65, 40), Shot.Aimed(110, 75) },
		Weight = 10,
	...
	private static readonly Dictionary<WeaponType, WeaponMetadata> metadata = new Dictionary<
		WeaponType,
		WeaponMetadata
	>
	{
