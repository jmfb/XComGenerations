...
namespace XCom.Screens
{
	public class BuildFacilities : Screen
	{
		public BuildFacilities()
		{
			...
			AddControl(
				new Border(40, 192, 128, 160, ColorScheme.DarkYellow, Backgrounds.Research, 12)
			);
			AddControl(new Label(48, 212, "Installation", Font.Large, ColorScheme.White));
			AddControl(
				new Button(176, 200, 112, 16, "OK", ColorScheme.DarkYellow, Font.Normal, OnOk)
			);
			AddControl(
				new ListView<FacilityType>(
					64,
					200,
					13,
					data.AvailableFacilityTypes,
					ColorScheme.DarkYellow,
					Palette.GetPalette(12).GetColor(230),
			...
			AddControl(
				new BaseFacilities(BaseFacilities.Mode.ViewFacilities, (row, column) => { })
			);
		}
