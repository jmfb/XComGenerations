...
namespace XCom.Screens
{
	public class MonthlyReport : Screen
	{
		public MonthlyReport(MonthlyReportCard reportCard)
		{
			...
			AddControl(
				new Label(8, 16, "XCOM PROJECT MONTHLY REPORT", Font.Large, ColorScheme.Green)
			);
			...
			AddControl(
				new Label(
					24,
					50,
					reportCard.Month.ToString("MMM yyyy"),
					Font.Normal,
					ColorScheme.Yellow
				)
			);
			...
			AddControl(
				new Label(24, 200, reportCard.Score.FormatNumber(), Font.Normal, ColorScheme.Yellow)
			);
			...
			AddControl(
				new Label(
					32,
					90,
					reportCard.FundingChange.FormatNumber(),
					Font.Normal,
					ColorScheme.Yellow
				)
			);
