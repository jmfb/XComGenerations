...
public class SellSack : Screen
{
	...
	public SellSack()
	{
		...
		AddControl(
			new Label(8, Label.Center, "Sell Items/Sack Personnel", Font.Large, ColorScheme.Blue)
		);
	...
	{
		foreach (
			var soldier in GameState.SelectedBase.Soldiers.Where(soldier => soldier.Craft == null)
		)
