...
public class BaseInformation : Screen
{
	public BaseInformation()
	{
		...
		AddControl(
			new Button(180, 46, 80, 14, "TRANSFERS", ColorScheme.Purple, Font.Normal, OnTransfers)
		);
		AddControl(
	...
	{
		AddControl(
			new Label(72, 8, "SPACE USED:SPACE AVAILABLE>", Font.Normal, ColorScheme.LightMagenta)
		);
	...
	private void CreateShortRangeDetectionRow()
	{
		...
		AddControl(
			new BaseInformationRow(153, "Short Range Detection", 128, 25, 1, total, total, false)
		);
	}
