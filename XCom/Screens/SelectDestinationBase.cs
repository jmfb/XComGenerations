...
public class SelectDestinationBase : Screen
{
	public SelectDestinationBase()
	{
		...
		var otherBases = GameState
			.Current.Data.Bases.Where(@base => !ReferenceEquals(@base, GameState.SelectedBase))
			.ToList();
		AddControl(
			new ListView<Data.Base>(
				80,
				28,
				7,
				otherBases,
				...
				.AddColumn(
					...
					Alignment.Left,
					@base => @base.Name,
					@base => ColorScheme.LightMagenta
				)
				.AddColumn(116, Alignment.Left, @base => @base.Area)
		);
		AddControl(
			new Button(146, 28, 264, 16, "Cancel", ColorScheme.DarkYellow, Font.Normal, OnCancel)
		);
	}
