...
namespace XCom.Screens
{
	public class CraftList : Screen
	{
		public CraftList()
		{
			...
			AddControl(
				new Border(0, 0, 320, 200, ColorScheme.LightMagenta, Backgrounds.EquipCraft, 9)
			);
			AddControl(
				new Label(8, 16, "INTERCEPTION CRAFT", Font.Large, ColorScheme.LightMagenta)
			);
			AddControl(
				new Label(24, 16, $"Base>{selectedBase.Name}", Font.Large, ColorScheme.LightMagenta)
			);
			...
			AddControl(
				new ListView<Craft>(
					...
					selectedBase.Crafts,
					ColorScheme.Blue,
					Palette.GetPalette(9).GetColor(230),
					OnSelectCraft
				)
