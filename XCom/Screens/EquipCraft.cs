...
public class EquipCraft : Screen
{
	...
	public EquipCraft(Craft craft)
	{
		...
		AddControl(
			new Label(24, 59, craft.DamagePercent.FormatPercent(), Font.Normal, ColorScheme.White)
		);
		AddControl(new Label(24, 232, "FUEL>", Font.Normal, ColorScheme.Blue));
		AddControl(
			new Label(24, 255, craft.FuelPercent.FormatPercent(), Font.Normal, ColorScheme.White)
		);
		AddControl(
			new Picture(35 + metadata.RowOffset, 125 + metadata.ColumnOffset, metadata.Image)
		);
		...
		{
			AddControl(
				new Button(96, 24, 64, 16, "CREW", ColorScheme.Blue, Font.Normal, OnClickCrew)
			);
			AddControl(
				new Button(
					120,
			...
			AddControl(
				new Button(144, 24, 64, 16, "ARMOR", ColorScheme.Blue, Font.Normal, OnClickArmor)
			);
		}
