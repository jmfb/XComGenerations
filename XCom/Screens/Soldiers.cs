...
namespace XCom.Screens
{
	public class Soldiers : Screen
	{
		...
		{
			AddControl(
				new Border(0, 0, 320, 200, ColorScheme.LightMagenta, Backgrounds.Soldier, 8)
			);
			...
			AddControl(
				new ListView<Soldier>(
					...
					.AddColumn(
						...
						GetSoldierColorScheme
					)
					.AddColumn(
						64,
						Alignment.Left,
						solider => solider.CraftName,
						GetSoldierColorScheme
					)
			);
			AddControl(
		...
		{
			return soldier.Craft == null ? ColorScheme.Purple : ColorScheme.Blue;
		}
