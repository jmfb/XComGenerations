...
namespace XCom.Screens
{
	public class Research : Screen
	{
		...
		public Research(Screen returnToScreen)
		{
			...
			AddControl(
				new Label(8, Label.Center, "CURRENT RESEARCH", Font.Large, ColorScheme.Blue)
			);
			...
			AddControl(
				new DynamicLabel(
					24,
					97,
					() => selectedBase.ScientistsAvailable.FormatNumber(),
					Font.Normal,
					ColorScheme.White
				)
			);
			...
			AddControl(
				new DynamicLabel(
					24,
					255,
					() => selectedBase.ScientistsAllocated.FormatNumber(),
					Font.Normal,
					ColorScheme.White
				)
			);
			AddControl(
				new Label(34, 8, "Laboratory Space Available>", Font.Normal, ColorScheme.Blue)
			);
			AddControl(
				new DynamicLabel(
					34,
					133,
					() => selectedBase.LaboratorySpaceAvailable.FormatNumber(),
					Font.Normal,
					ColorScheme.White
				)
			);
			...
			AddControl(
				new ListView<ResearchProject>(
					54,
					8,
					15,
					GameState.SelectedBase.ResearchProjects,
					ColorScheme.Purple,
					selectionColor,
					OnClickResearch
				)
					...
					.AddColumn(
						82,
						Alignment.Left,
						research => research.ScientistsAllocated.FormatNumber()
					)
