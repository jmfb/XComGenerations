...
namespace XCom.Modals
{
	public class ChooseNewResearchProject : Screen
	{
		public ChooseNewResearchProject()
		{
			...
			AddControl(new ListView<ResearchType>(54, 53, 11, GameState.Current.Data.GetAvailableResearchProjects(), ColorScheme.White, selectionColor, OnClickResearchType)
