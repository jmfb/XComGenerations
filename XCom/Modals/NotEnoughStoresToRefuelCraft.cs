...
namespace XCom.Modals
{
	public class NotEnoughStoresToRefuelCraft : Screen
	{
		public NotEnoughStoresToRefuelCraft(Data.Base @base, Craft craft)
		{
			...
			AddControl(
				new Label(66, Label.Center, "Not enough Elerium-115", Font.Large, ColorScheme.Green)
			);
			AddControl(
				new Label(
					82,
					Label.Center,
					$"to refuel {craft.Name}",
					Font.Large,
					ColorScheme.Green
				)
			);
			AddControl(
				new Label(98, Label.Center, $"at {@base.Name}", Font.Large, ColorScheme.Green)
			);
			AddControl(
