...
namespace XCom.Modals
{
	public class EditProduction : Screen
	{
		...
		public EditProduction(ManufactureProject production)
		{
			...
			AddControl(
				new Border(25, 0, 320, 150, ColorScheme.LightMagenta, Backgrounds.Workshop, 1)
			);
			AddControl(
				new Label(
					35,
					Label.Center,
					production.ManufactureType.Metadata().Name,
					Font.Large,
					ColorScheme.LightMagenta
				)
			);
			AddControl(
				new Label(55, 16, "ENGINEERS AVAILABLE>", Font.Normal, ColorScheme.LightMagenta)
			);
			AddControl(
				new DynamicLabel(
					55,
					113,
					() => selectedBase.EngineersAvailable.FormatNumber(),
					Font.Normal,
					ColorScheme.White
				)
			);
			...
			AddControl(
				new DynamicLabel(
					65,
					139,
					() => selectedBase.WorkshopSpaceAvailable.FormatNumber(),
					Font.Normal,
					ColorScheme.White
				)
			);
			...
			AddControl(
				new DynamicLabel(
					85,
					135,
					() => production.EngineersAllocated.FormatNumber(),
					Font.Large,
					ColorScheme.White
				)
			);
			...
			AddControl(
				new DynamicLabel(
					85,
					279,
					() => production.UnitsToProduce.FormatNumber(),
					Font.Large,
					ColorScheme.White
				)
			);
			...
			AddControl(
				new Button(150, 168, 135, 16, "OK", ColorScheme.Purple, Font.Normal, EndModal)
			);
		}
		...
		private void OnIncreaseEngineers()
		{
			...
			var areMoreEngineersAllowedOnProject =
				production.EngineersAllocated < maximumEngineersAllowed;
			if (
				areEngineersAvailable
				&& isWorkshopSpaceAvailable
				&& areMoreEngineersAllowedOnProject
			)
