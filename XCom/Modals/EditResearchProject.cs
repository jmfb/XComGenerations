...
namespace XCom.Modals
{
	public class EditResearchProject : Screen
	{
		...
		public EditResearchProject(ResearchProject research)
		{
			...
			AddControl(
				new Border(30, 45, 230, 140, ColorScheme.DarkYellow, Backgrounds.Research, 7)
			);
			AddControl(new Label(40, 61, research.GetName(), Font.Large, ColorScheme.DarkYellow));
			AddControl(
				new Label(60, 61, "SCIENTISTS AVAILABLE>", Font.Normal, ColorScheme.DarkYellow)
			);
			AddControl(
				new DynamicLabel(
					60,
			...
			AddControl(
				new Label(80, 61, "Scientists Allocated>", Font.Large, ColorScheme.DarkYellow)
			);
			AddControl(
				new DynamicLabel(
					80,
