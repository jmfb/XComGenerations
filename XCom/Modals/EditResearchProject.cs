...
public class EditResearchProject : Screen
{
	...
	public EditResearchProject(ResearchProject research)
	{
		...
		AddControl(
			new Label(70, 61, "LABORATORY SPACE AVAILABLE>", Font.Normal, ColorScheme.DarkYellow)
		);
		AddControl(
			new DynamicLabel(
				70,
		...
		AddControl(
			new DynamicLabel(
				80,
				231,
				() => research.ScientistsAllocated.FormatNumber(),
				Font.Large,
				ColorScheme.White
			)
		);
		...
		AddControl(
			new Repeater(100, 195, 13, 14, "U", ColorScheme.DarkYellow, Font.Arrow, OnIncrease, 50)
		);
		AddControl(new Label(120, 85, "Decrease", Font.Large, ColorScheme.DarkYellow));
		AddControl(
			new Repeater(120, 195, 13, 14, "D", ColorScheme.DarkYellow, Font.Arrow, OnDecrease, 50)
		);
