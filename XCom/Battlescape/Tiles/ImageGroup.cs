...
namespace XCom.Battlescape.Tiles
{
	public class ImageGroup
	{
		...
		public static readonly ImageGroup Brain = new ImageGroup(
			ImageTables.Brain,
			ImageGroups.Brain
		);
		...
		public static readonly ImageGroup Roads = new ImageGroup(
			ImageTables.Roads,
			ImageGroups.Roads
		);
		...
		public static readonly ImageGroup Polar = new ImageGroup(
			ImageTables.Polar,
			ImageGroups.Polar
		);
