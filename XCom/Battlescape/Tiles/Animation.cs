...
namespace XCom.Battlescape.Tiles
{
	public class Animation
	{
		...
		public static readonly Animation SoldierCoverallsDeath = new Animation(
			ImageGroup.SoldierCoveralls,
			264,
			3
		);
		public static readonly Animation SoldierPersonalArmorDeath = new Animation(
			ImageGroup.SoldierPersonalArmor,
			264,
			3
		);
		public static readonly Animation SoldierPowerSuitDeath = new Animation(
			ImageGroup.SoldierPowerSuit,
			264,
			3
		);
		public static readonly Animation CivilianFemaleDeath = new Animation(
			ImageGroup.CivilianFemale,
			72,
			3
		);
		public static readonly Animation CivilianMaleDeath = new Animation(
		...
		public static readonly Animation ChryssalidDeath = new Animation(
			ImageGroup.Chryssalid,
			224,
			3
		);
		public static readonly Animation FloaterDeath = new Animation(ImageGroup.Floater, 64, 3);
		public static readonly Animation SnakemanDeath = new Animation(ImageGroup.Snakeman, 96, 3);
	}
}
