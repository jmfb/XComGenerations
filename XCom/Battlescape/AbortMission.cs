...
namespace XCom.Battlescape
{
	public class AbortMission : Screen
	{
		public AbortMission()
		{
			...
			AddControl(
				new Label(50, 60, "0 Units outside Exit Area", Font.Large, ColorScheme.White)
			);
			AddControl(
				new Label(75, Label.Center, "Abort Mission ?", Font.Large, ColorScheme.White)
			);
			AddControl(new Button(110, 16, 120, 18, "OK", ColorScheme.White, Font.Normal, OnOk));
			AddControl(
				new Button(110, 185, 120, 18, "CANCEL", ColorScheme.White, Font.Normal, EndModal)
			);
		}
