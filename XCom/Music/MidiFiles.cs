...
namespace XCom.Music
{
	...
	{
		private static readonly MidiFile battlescape = new MidiFile(
			Content.Music.Music.Battlescape
		);
		...
		private static readonly MidiFile introduction1 = new MidiFile(
			Content.Music.Music.Introduction1
		);
		private static readonly MidiFile introduction2 = new MidiFile(
			Content.Music.Music.Introduction2
		);
		private static readonly MidiFile introduction3 = new MidiFile(
			Content.Music.Music.Introduction3
		);
