...
namespace XCom.Music
{
	...
	public static class BattlescapeSoundEffectExtensions
	{
		...
		private static readonly SoundPlayer bigGunShot = new SoundPlayer(
			BattlescapeSounds.BigGunShot
		);
		private static readonly SoundPlayer blasterLaunch = new SoundPlayer(
			BattlescapeSounds.BlasterLaunch
		);
		private static readonly SoundPlayer bulletHit = new SoundPlayer(
			BattlescapeSounds.BulletHit
		);
		...
		private static readonly SoundPlayer itemThrow = new SoundPlayer(
			BattlescapeSounds.ItemThrow
		);
		private static readonly SoundPlayer largeExplosion = new SoundPlayer(
			BattlescapeSounds.LargeExplosion
		);
		private static readonly SoundPlayer laserShot = new SoundPlayer(
			BattlescapeSounds.LaserShot
		);
		...
		private static readonly SoundPlayer mindProbe = new SoundPlayer(
			BattlescapeSounds.MindProbe
		);
		private static readonly SoundPlayer mutonScream = new SoundPlayer(
			BattlescapeSounds.MutonScream
		);
		private static readonly SoundPlayer plasmaShot = new SoundPlayer(
			BattlescapeSounds.PlasmaShot
		);
