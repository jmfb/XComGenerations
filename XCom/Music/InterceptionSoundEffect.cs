...
namespace XCom.Music
{
	...
	public static class InterceptionSoundEffectExtensions
	{
		...
		private static readonly SoundPlayer plasmaCannon = new SoundPlayer(
			Interception.PlasmaCannon
		);
		...
		private static readonly SoundPlayer ufoExplosion = new SoundPlayer(
			Interception.UfoExplosion
		);
